...
class CustomerControllerIntegrationTest {
    ...
    void testGetCustomerById() throws Exception {
        mockMvc.perform(get("/api/customers/{id}", customer1.getId()))
                .andExpect(status().isOk())
    ...
    void testUpdateCustomer() throws Exception {
        String updatedCustomerJson = "{\"name\":\"Updated Customer\",\"email\":\"updated.customer@example.com\"}";
    ...
    void testDeleteCustomer() throws Exception {
        mockMvc.perform(delete("/api/customers/{id}", customer1.getId()))
