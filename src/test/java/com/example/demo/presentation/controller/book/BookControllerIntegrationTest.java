...
class BookControllerIntegrationTest {
    ...
    void testGetBookByIsbnNotFound() throws Exception {
        mockMvc.perform(get("/api/books/{isbn}", "nonexistent"))
    ...
    void testCreateBook() throws Exception {
        String newBookJson = "{\"isbn\":\"9781234567890\",\"title\":\"New Book\",\"price\":1000,\"stock\":10}";
    ...
    void testUpdateBook() throws Exception {
        ...
        mockMvc.perform(put("/api/books/{isbn}", book.getIsbn())
                .contentType(MediaType.APPLICATION_JSON)
    ...
    void testUpdateBookNotFound() throws Exception {
        ...
        mockMvc.perform(put("/api/books/{isbn}", "nonexistent")
                .contentType(MediaType.APPLICATION_JSON)
                .content(updatedBookJson))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$.error", is("Book not found with ISBN: nonexistent")));
    ...
    void testDeleteBook() throws Exception {
        ...
        mockMvc.perform(delete("/api/books/{isbn}", book.getIsbn()))
    ...
    void testDeleteBookNotFound() throws Exception {
        mockMvc.perform(delete("/api/books/{isbn}", "nonexistent"))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$.error", is("Book not found with ISBN: nonexistent")));
    }
}
